...
// https://s1.adform.net/Banners/Elements/Templates/12821/18176.xml is used in this banner
...
dhtml.setupProducts({
	...
	pageSize:   parseInt(dhtml.getVar('pageSize', 0), 10), //How many products to show
	stepSize:   parseInt(dhtml.getVar('stepSize', 0), 10), //how many products to scroll
...
function productsCallback(error, productsInstance) {
  if (error) {
	...
	/**
	 * itemHide event is emited for each item that is not used in animation.
	 */
